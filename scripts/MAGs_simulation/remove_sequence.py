    """
    Removes specified ranges from a given sequence, to simulates MAGs
    Author : Dr. Samuel Horsfield
...
def main():
    ...
    for index, completeness in enumerate(completeness_array):
        ...
        SeqIO.write(output_sequences, outdir + "/" + basename + "_comp_" + str(round(completeness, 4)) + ".fa", 'fasta')
